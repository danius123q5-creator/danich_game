...
public class MissileSilo : Buildable
{
    ...
    float blastR = 5.5f;     // explosion radius
    float blastDmg = 350f;   // splash damage
    ...
    protected override void ApplyLevel()
    {
        ...
        {
            case 1: MaxHealth = 500f; blastDmg = 350f; blastR = 5.5f; reload = 5f; break;
            case 2: MaxHealth = 640f; blastDmg = 440f; blastR = 6.2f; reload = 4f; break;
            default: MaxHealth = 800f; blastDmg = 560f; blastR = 7f; reload = 3f; break;
        }
        Health = MaxHealth;
    }
    ...
    protected override void BuildableTick()
    {
        ...
        Vector3 to = center.transform.position + Vector3.up * 1f;
        Rocket.Launch(from, to, blastR, blastDmg, 45f);
    }
