...
public class PlayerController : MonoBehaviour
{
    ...
    static readonly string[] BuildDescriptions =
    {
        ...
        "Ракетная шахта: ждёт толпу (3+ зомби) и пускает ракету в одного зомби — она взлетает в небо и падает на него, а ЖИРНЫЙ сплеш сносит всех вокруг (радиус 10-16). Работает как турель, без расхода металла. Дорогая.",
