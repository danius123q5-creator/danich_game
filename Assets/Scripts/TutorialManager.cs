...
public class TutorialManager : MonoBehaviour
{
    ...
    static readonly string[] Hints =
    {
        ...
        "Захвачено! НПЗ даёт НЕФТЬ — на ней работают супер-пушки (Тесла, Орбиталка). ШАХТЫ дают металл. Точки надо захватывать и ОБОРОНЯТЬ. Труба/конвейер тянутся линией (зажми ЛКМ у источника, веди к базе), а дозатор/чан у базы сами выдают ресурс.",
